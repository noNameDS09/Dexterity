  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          variants={itemVars}
          className="text-base sm:text-lg md:text-2xl text-stone-400 mb-10 tracking-[0.25em] uppercase italic"
        >
          Where <span className="text-amber-200/70">Logic</span> Meets{" "}
          <span className="text-amber-200/70">Legends</span>
        </motion.p>
        ...
        >
          <button className="px-8 py-3 border border-amber-200/30 text-amber-100 bg-stone-900/50 backdrop-blur-sm hover:bg-amber-200 hover:text-stone-900 transition-colors duration-500 font-cinzel tracking-widest text-sm uppercase">
            ...
            <a
              href="#events"
              // className="inline-block px-8 py-3 border border-amber-200/30 text-amber-100
              //            bg-stone-900/50 backdrop-blur-sm
              //            hover:bg-amber-200 hover:text-stone-900
